      ...
      if (length(files) > 0) {
        lapply(files, function(x){
          ...
          if (grepl('\\.html$', path_end)) {
            li_item = tags$li(tags$a(path_end, href=paste0(params$github_site_url, x)))
